...
class Text(GraphicsObject):
    ...
    def setFace(self, face):
        if face in ['helvetica','arial','Karma Future','Player 1 Up Black','Frostbite Boss Fight','All the Way to the Sun','Slope Opera','Bahnschrift SemiLight Condensed','Azonix','courier','SNES','times roman','Sportypo','Botsmatic Outline','Black And White Display']:
...
class Entry(GraphicsObject):
    ...
    def setFace(self, face):
        if face in ['helvetica','arial','courier','Karma Future','Player 1 Up Black','Frostbite Boss Fight','All the Way to the Sun','Slope Opera','Bahnschrift SemiLight Condensed','Azonix','SNES','times roman','Sportypo','Botsmatic Outline','Black And White Display']:
